...
const initialState: Movie[] = [
    ...
    },
    {
        ...
        genres: [Genre.crime, Genre.drama, Genre.sport],
        rate: 6.9,
        length: '2hr 5mins',
    ...
    },
    {
        ...
        genres: [Genre.biography, Genre.crime, Genre.drama],
        rate: 7.8,
        length: '2hr 37mins',
    ...
    },
    {
        ...
        genres: [Genre.action, Genre.drama, Genre.sport],
        rate: 7.5,
        length: '2hr 4mins',
        img: 'southpaw.jpg'
    },
    {
        ...
        genres: [Genre.biography, Genre.drama, Genre.thriller],
        rate: 7.7,
        length: '2hr 22mins',
...
export function moviesReducer(state: Movie[] = initialState, action: Action) {
    switch (action.type) {
        default:
            return state;
    }
